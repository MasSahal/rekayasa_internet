...
<body>
	<div class="login-page">
					...
					<div class="row gx-0 align-items-stretch">
						...
						<div class="col-lg-6 bg-white">
							<div class="d-flex align-items-center px-4 px-lg-5 h-100">
								<form class="login-form py-5 w-100" method="post" action="./proses/app.php">
									...
									<button class="btn btn-primary mb-3" type="submit"><i class="fa fa-sign-in" aria-hidden="true"></i> Masuk</button>
		...
		<div class="text-center position-absolute bottom-0 start-0 w-100 z-index-20">
			<p class="text-white">Design by <a class="external" href="massahal.my.id">Mas Sahal - Ms Technology</a>
			</p>
		</div>
	</div>
