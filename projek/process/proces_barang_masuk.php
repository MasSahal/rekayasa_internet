...
if ($aksi == "tambah") {
    ...
    if ($insert) {
        ...
        echo '<div class="alert alert-danger" role="alert">
                <strong>Data gagal melakukan proses simpan! </strong><a href=../views/administrator/data_barang_masuk.php>Klik Disini!</a>
            </div>';
    }
} else if ($aksi == "update") {
    ...
    if ($kd_barang != null) {
        ...
        echo '<div class="alert alert-danger" role="alert">
                <strong>Tidak ada data yang diupdate! </strong><a href=../views/administrator/data_barang_masuk.php>Klik Disini!</a>
            </div>';
    }
} else if ($aksi == "delete") {
    ...
    echo `  
            <div class="alert alert-danger" role="alert">
                <strong>Data gagal disimpan! </strong><a href=../views/administrator/>data_barang_masuk.php>Klik Disini!</a>
            </div>
        `;
};
