...
if (!isset($_SESSION['namauser'])) { ?>
    <script>
        window.location = '../../login.php?pesan=gagal&&msg=<?= urlencode('Anda Belum Login!'); ?>'
    </script>
<?php } ?>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../../process/proses_login.php?aksi=logout" onclick="return confirm('Yakin ingin logout?')">Log-Out</a>
                </li>
            </ul>
            <form class="d-flex mb-2 mb-lg-0">
                ...
                <strong class="text-white">Halo, <?= $_SESSION['nama'] . " - " . $_SESSION['status']; ?></strong>
            </form>
        </div>
    </div>
</nav>
