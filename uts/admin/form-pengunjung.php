                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan nama" value="<?= array_rand(['Salman', 'Andi', 'Abu Ali', 'Hilman', 'Sandhika']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" name="email" id="email" class="form-control" placeholder="Masukan email" value="<?= array_rand(['Salman@mail.com', 'Andi@mail.com', 'Abu Ali@mail.com', 'Hilman@mail.com', 'Sandhika']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat </label>
                                    <textarea class="form-control" name="alamat" id="alamat" rows="3" required placeholder="Masukan alamat ..."><?= array_rand(['JAKARTA', 'JAMBI', 'BENGKULU', 'MEDAN', 'SOLO']); ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="telepon">Telepon</label>
                                    <input type="number" min="1" max="9999999999999" name="telepon" id="telepon" class="form-control" placeholder="Masukan telepon" value="<?= rand(1000, 100000); ?>" required>
                                </div>
                                <div class="form-group">
