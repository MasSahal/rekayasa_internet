...
{
    $db = new database();
    $pe = $db->getReservasi($_GET['reservasi_id']);
    $pengunjung = $db->getPengunjung();
    $kamar = $db->getKamar();
    if ($pe) {
    ?>
                        ...
                        <form action="process/reservasi.php?aksi=update" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="reservasi_id">ID reservasi</label>
                                        <input type="text" name="reservasi_id" id="reservasi_id" class="form-control" value="<?= $pe['reservasi_id']; ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="pengunjung_id">Pilih Pengunjung</label>
                                        <select class="form-control" name="pengunjung_id" id="pengunjung_id">
                                            <option selected disabled>-- Select --</option>
                                            <?php foreach ($pengunjung as $p) { ?>
                                                <option value="<?= $p['pengunjung_id']; ?>" <?= $p['pengunjung_id'] == $pe['pengunjung_id'] ? "selected" : "" ?>><?= $p['nama']; ?></option>
                                            <?php }; ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kamar_id" id="kamar_id">
                                            <option selected disabled>-- Select --</option>
                                            <?php foreach ($kamar as $k) { ?>
                                                <option value="<?= $k['kamar_id']; ?>" <?= $k['kamar_id'] == $pe['kamar_id'] ? "selected" : "" ?>>Kamar <?= $k['nama_kamar'] . " - Harga : " . $db->harga($k['harga_kamar']) ?></option>
                                            <?php }; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="check_in">Tanggal Check-In</label>
                                        <input type="date" name="check_in" id="check_in" class="form-control" value="<?= $pe['check_in']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="check_out">Tanggal Check-Out</label>
                                        <input type="date" name="check_out" id="check_out" class="form-control" value="<?= $pe['check_out']; ?>" required>
                                    </div>
                            ...
                            <div class="col-md-8">
                                <table class="table table-borderless w-75">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <span><?= $db->harga($p['total_biaya']); ?></span><br>
                                            <small><i>Jumlah hari x Harga Kamar</i></small>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Alamat</th>
