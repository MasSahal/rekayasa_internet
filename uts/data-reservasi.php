                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    ...
                                    <div class="ms-auto">
                                        <a href="?aksi=tambah" class="btn btn-info float-right"><i class="mdi mdi-plus" aria-hidden="true"></i>Tambah Reservasi</a>
                                    </div>
                                </div>
                                <hr>
                            </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    |
                                                    <a name="" id="" class="btn btn-warning btn-sm" href="process/reservasi.php?aksi=delete&&reservasi_id=<?= $k['reservasi_id']; ?>" role="button" onclick="return confirm('Yakin ingin menghapus reservasi <?= $k['reservasi_id']; ?> ?')">
