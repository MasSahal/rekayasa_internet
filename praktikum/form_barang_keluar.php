...
?>
    <div class="col-4" style="border: 1px solid lightgray; border-radius: 10px; padding: 10px;">
        <h3 style="text-align: center; background-color: lightblue; border-radius: 10px; color: white; padding: 10px;">
            Update Barang</h3>
        <form method="post" action="<?= "../process/proses_barang_keluar.php?aksi=update"; ?>" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" min="1" class="form-control" placeholder="Masukkan Jumlah Barang" value="<?= $barang_keluar['jumlah']; ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="penerima" class="form-control" placeholder="Masukkan penerima" value="<?= $barang_keluar['penerima']; ?>" required>
            </div>
...
?>
    ...
    <div class="col-4" style="border: 1px solid lightgray; border-radius: 10px; padding: 10px;">
        <h3 style="text-align: center; background-color: lightblue; border-radius: 10px; color: white; padding: 10px;">Input
            Barang Keluar</h3>
        <form method="post" action="<?= "proses_barang_keluar.php?aksi=tambah"; ?>" enctype="multipart/form-data">
            <div class="mb-3">
                <label class="form-label">No Ref</label>
