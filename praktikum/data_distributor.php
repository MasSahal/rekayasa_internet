                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border border-dark text-center">
                            ...
                            <td align="center">
                                <a class="btn btn-outline-success text-black"
                                    href="<?php echo "data_distributor.php?&edit=update&&id=$row[kd_distributor]"; ?>">Edit</a>
                                <a class="btn btn-outline-success text-black"
                                    href="<?php echo "proses_distributor.php?aksi=delete&&id=$row[kd_distributor]"; ?>"
                                    onclick="javascript: return confirm('Apakah yakin data dihapus')">Delete</a>
                            </td>
                        </tr>
                        <?php
                        }
